      ...
      preguntas: [
        {
          id: 1,
          texto:
            'El producto es todo aquello que se ofrece al mercado para satisfacer una necesidad o deseo.',
        ...
        },
        {
          id: 7,
          texto:
            'Todos los servicios incluyen transferencia de propiedad sobre un bien físico.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 14,
          texto:
            'Un portafolio mal estructurado puede afectar la percepción del cliente sobre la empresa.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 19,
          texto:
            'El portafolio simple es ideal para empresas que desean llegar a muchos mercados distintos.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
